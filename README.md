# IFX - Projeto Aplicado

## 26/02 - Avaliando criação de blocos de armazenamento (File Block Simulator)
We've created `meu_disco_raw.bin` with a function, verifying if file already exists, else the code create and then use `lseek` to point to head file.
